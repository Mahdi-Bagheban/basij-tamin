...
import { toFaChars, uniq, deepFreeze } from './utils.js';

/* ——— استان/شهر (منوی شهر وابسته به استان) ——— */
const PROVINCES_CITIES_RAW = {
    "آذربایجان شرقی": ["تبریز", "مراغه", "مرند", "میانه", "اهر", "بناب", "سراب", "آذرشهر", "عجب‌شیر", "شبستر", "ملکان", "هوراند", "کلوانق", "ترک", "آبش احمد", "هشترود", "زرنق", "ترکمانچای", "ورزقان", "تسوج", "زنوز", "ایلخچی", "شرفخانه", "مهربان", "مبارک شهر", "تیکمه داش", "باسمنج", "سیه رود", "خمارلو", "خواجه", "قره آغاج", "وایقان", "ممقان", "خامنه", "خسروشاه", "لیلان", "نظرکهریزی", "بخشایش", "آقکند", "جوان قلعه", "کلیبر", "اسکو", "شندآباد", "شربیان", "گوگان", "بستان آباد", "جلفا", "اچاچی", "هریس", "یامچی", "خاروانا", "کوزه کنان", "خداجو", "کشکسرای", "سهند", "سیس", "دوزدوزان", "تیморلو", "صوفیان", "سردرود", "هادیشهر"],
    ...
    "هرمزگان": ["بندرعباس", "میناب", "دهبارز", "بندر لنگه", "کیش", "قشم", "جاسک", "سیریک", "خمیر"],
...
function buildProvinceCities() {
    ...
    // فرض بر این است که toFaChars و uniq در module موجود است
    const out = {};
...
export { PROVINCES_CITIES_RAW, buildProvinceCities };

// Initialize
const PROVINCES_CITIES = buildProvinceCities();
...
const getCitiesOf = (provinceName) => {
    ...
    return key ? PROVINCES_CITIES[key] : [];
};

export { PROVINCES_CITIES, PROVINCE_LIST, getCitiesOf };